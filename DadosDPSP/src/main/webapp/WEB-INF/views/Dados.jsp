                ...
                <div class="row">
                  	...
                  	<form class="" action="Buscar" method="GET">
                  		<div class="col-7">
                  			<div class="row">
                  				<div class="col-8">
                  					<input type="text" class="form-control" name="id" placeholder="${dados._id }" id="id" maxlength="4" onkeypress='return SomenteNumero(event)' required value="">
                  				</div>
                  				<div class="col-4">
...
<%--           					<input type="text" class="form-control" id="ipPadrao" readonly value="${dados.ipGerencia }"> --%>
          					<input type="text" class="form-control" id="ipPadrao" readonly value="">
          				</div>
          			</div>
          			<div class="row">
          				<div class="col-5">
...
<%--           					<input type="text" class="form-control" id="ipExtenso" readonly value="${dados.ipBalcao }"> --%>
          					<input type="text" class="form-control" id="ipExtenso" readonly value="">
          				</div>
          			</div>
          			<div class="row">
          				<div class="col-5">
...
<%--                     <input type="text" class="form-control" id="usuarioPopular" readonly value="${dadosPopular.usuarioPopular }"> --%>
						<input type="text" class="form-control" id="usuarioPopular" readonly value="">
                  </div>
                </div>
                <div class="row">
                  <div class="col-4">
...
<%--                     <input type="text" class="form-control" id="senhaPopular" readonly value="${dadosPopular.senhaPopular }"> --%>
						<input type="text" class="form-control" id="senhaPopular" readonly value="">
                  </div>
                </div>
              </div>
            </div>
...
<%--                           <input type="text" class="form-control" id="estabelecimentoCielo" readonly value="${dadosPinpad.estabelecimentoCielo }"> --%>
								<input type="text" class="form-control" id="estabelecimentoCielo" readonly value="">
                        </div>
                      </div>
                      <br>
                      <div class="row" style="padding-left: 40px">
