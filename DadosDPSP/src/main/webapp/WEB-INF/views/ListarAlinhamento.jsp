						...
						<table class="table table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">Andrespx</th>
                                        <th scope="col">Buenoga</th>
                                        <th scope="col">Eduaopa</th>
                                        <th scope="col">Enasilva</th>
                                        <th scope="col">Felneves</th>
                                        <th scope="col">Felsan</th>
                                        <th scope="col">Ferlapx</th>
                                        <th scope="col">Gabaf</th>
                                        <th scope="col">Gsoli</th>
                                        <th scope="col">Guhfs</th>
                                        <th scope="col">Jquei</th>
                                        <th scope="col">Juancda</th>
                                        <th scope="col">Leiper</th>
                                        <th scope="col">Ligiar</th>  
                                        <th scope="col">Lilianfp</th>
                                        <th scope="col">Malonec</th> 
                                        <th scope="col">Marcoabj</th>
                                        <th scope="col">Mariaels</th>
                                        <th scope="col">Mayss</th>
                                        <th scope="col">Mfdiaspx</th>
                                        <th scope="col">Munizn</th>
                                        <th scope="col">Murisil</th>
                                        <th scope="col">Ofaria</th>
                                        <th scope="col">Oliversi</th>
                                        <th scope="col">Petma</th>
                                        <th scope="col">Phperepx</th>
                                        <th scope="col">Pjordaot</th>
                                        <th scope="col">Rafaelos</th>
                                        <th scope="col">Rafsanco</th>
                                        <th scope="col">Rodolfob</th>
                                        <th scope="col">Rrslima</th>
                                        <th scope="col">Ssabrina</th>
                                        <th scope="col">Tdom</th> 
                                        <th scope="col">Vilanopx</th>
                                        <th scope="col">Wellinlo</th>
                                        <th scope="col"> </th>
                                        <th scope="col"> </th>
                                    </tr>
                                </thead>
                                <tbody >                           	
                                 	<c:forEach var="alinhamento" items="${list}">
                                 		<tr>
                                            ...
                                            <td>
                                                ${alinhamento.enasilva }
                                            </td>
                                            <td>
                                                ${alinhamento.felneves }
                                            </td>
                                            <td>
                                                ${alinhamento.felsan }
                                            </td>
                                            ...
                                            <td>
                                                ${alinhamento.lilianfp}
                                            </td>
                                            <td>
                                                ${alinhamento.malonenc}
                                            </td>
                                            <td>
                                                ${alinhamento.marcoabj }
                                            </td>
                                            <td>
                                                ${alinhamento.mariaels }
                                            </td>
                                           	<td>
                                                ${alinhamento.mayss }
                                            </td>
                                            <td>
                                                ${alinhamento.mfdiaspx }
                                            </td>
                                            <td>
                                                ${alinhamento.munizn }
                                            </td>
                                            ...
                                            <td>
                                                ${alinhamento.oliversi }
                                            </td>
                                            <td>
                                                ${alinhamento.petma }
                                            </td>
                                            <td>
                                                ${alinhamento.phperepx }
                                            </td>
                                            <td>
                                                ${alinhamento.pjordaot }
                                            </td>
                                            <td>
                                                ${alinhamento.rafaelos }
                                            </td>
                                            <td>
                                                ${alinhamento.rafsanco }
                                            </td>
                                           	<td>
                                                ${alinhamento.rodolfob }
                                            </td>
                                            <td>
                                                ${alinhamento.rrslima }
                                            </td>
                                            <td>
                                                ${alinhamento.ssabrina }
                                            </td>
                                            <td>
                                                ${alinhamento.tdom }
                                            </td>
                                            <td>
                                                ${alinhamento.vilanopx }
                                            </td>
                                            <td>
                                                ${alinhamento.wellinlo }
                                            </td>
                                            <td>
                                            	<form action="AlteraAlinhamento" method="GET">
                                                	<input type="hidden" name="id" value="${alinhamento._id }">
                                                	<button type="submit" class="btn btn-primary">Alterar</button>
                                                </form>
                                            </td>
                                            <td>
                                           		<form action="DeletarDocumento" method="GET">
                                                	<input type="hidden" name="id" value="${alinhamento._id }">
