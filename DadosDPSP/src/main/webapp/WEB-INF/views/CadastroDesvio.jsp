        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-6">
                    <div class="row"></div>
                    <div class="row">
                        <h1>Cadastro de Desvios</h1>
                    </div>
                </div>
                <div class="col-2"></div>
            </div>
            <form action="/CadastrarDesvio" method="POST">
                    ...
                    <div class="col-10">
                            ...
                            <div class="col-4">
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="inputGroup-sizing-default">Nº do Chamado</span>
                                    </div>
                                    <input type="text" class="form-control" name="_id" aria-label="Sizing example input" maxlength="11" aria-describedby="inputGroup-sizing-default" required value="">
                                </div>
                            </div>
                            <div class="col-5">
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="inputGroup-sizing-default">Data/Hora Abertura</span>
                                    </div>
                                    <input type="text" class="form-control" name="dtHoraAbertura" aria-label="Sizing example input" maxlength="11" aria-describedby="inputGroup-sizing-default" required value="">
                                </div>
                            </div>
                            <div class="col-3">
                                  <div class="input-group mb-3">
                                    ...
                                    <select class="custom-select" id="prioridade" name="prioridade">
                                        ...
                                        <option required value="3">3</option>
                                        <option required value="4">4</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="inputGroup-sizing-default">Dt/Hora Tratativa</span>
                                    </div>
                                    <input type="text" class="form-control" name="dtHoraTratativa" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" value="" required>
                                </div> 
                            </div>
                            <div class="col-6">
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="inputGroup-sizing-default">Dt/Hora Retorno</span>
                                    </div>
                                    <input type="text" class="form-control" name="dtHoraDevolucao" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" value="" required>
                                </div> 
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="inputGroup-sizing-default">Analista que devolveu</span>
                                    </div>
                                    <input type="text" class="form-control" name="analistaDevolucao" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" value="" required>
                                </div> 
                            </div>
                            <div class="col-6">
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="inputGroup-sizing-default">Fila que devolveu</span>
                                    </div>
                                    <input type="text" class="form-control" name="filaDevolucao" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" value="" required>
                                </div> 
                            </div>
                        </div>
                    </div>
                ...
                <br>
                <div class="row" style="padding-top: 10px; padding-bottom: 30px; border: 2px; border-style: solid; border-width: 100%; border-radius: 10px">
					<div class="col-1"></div>
					<div class="col-10">
						<div class="row">
                    		<div class="col-4"></div>
                    		<div class="col-4">
                    			<h4>Dados do Desvio</h4>		
                    		</div>
                    		<div class="col-4"></div>
                    	</div>
                    	<div class="row">
                    		<div class="col-3">
                    			<div class="input-group mb-3">
  									...
  									<select class="custom-select" id="timeDesvio" name="timeDesvio" onchange="optionCheckTime()">
    									<option selected>Escolher...</option>
    									<option value="Desvios_DPSP">Grupo DPSP</option>
    									<option value="Desvios_SD">SD IBM</option>
  									</select>
								</div>
                    		</div>
                    		<div class="col-4">
                    			<div class="input-group mb-3">
  									<div class="input-group-prepend">
    									<label class="input-group-text" for="inputGroupSelect01">Tipo de Analise</label>
  									</div>
  									<select class="custom-select" id="tipoAnalise" name="tipoAnalise" onchange="optionCheckTipoDesvio()">
    									<option selected>Escolher...</option>
                    		...
                    		<div class="col-5">
								 <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="inputGroup-sizing-default">Data do Desvio</span>
                                    </div>
                                    <input type="text" class="form-control" name="dtDesvio" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" value="" required>
                                </div> 
                    		</div>
                    	</div>
                    	<div class="row">
                    		<div class="col-6">
                    			<div class="row">
                    				<div class="input-group mb-3">
  										<div class="input-group-prepend">
    										<label class="input-group-text" for="inputGroupSelect01">Analista</label>
  										</div>
  										<select class="custom-select" id="analistaDesvio" name="analistaDesvio" onchange="optionCheckAnalista()">
    										<option selected>Escolher...</option>
  										</select>
									</div>
                    			</div>
                    		...
                    		<div class="col-6">
                    			<div class="input-group mb-3">
  									<div class="input-group-prepend">
    									<label class="input-group-text" for="inputGroupSelect01">Tipo de Desvio</label>
  									</div>
  									<select class="custom-select" id="tipoDesvio" name="tipoDesvio">
    									<option selected>Escolher...</option>
  									</select>
								</div>
                    		</div>
                    	...
                    	<div class="row">
                    		<div class="col-6">
                    			<div class="row">
                    				<div class="input-group mb-3">
  										<div class="input-group-prepend">
    										<label class="input-group-text" for="inputGroupSelect01">Fila do Analista</label>
  										</div>
  										<select class="custom-select" id="filaAnalista" name="filaAnalista">
    										<option selected>Escolher...</option>
  										</select>
									</div>
                    			</div>
                    			<div class="row" style="padding-top: 20px">
                    				...
                    				<div class="8">
                    					<div class="row">
                    						<input type="hidden" name="logon" id="logon" value="">
                    					</div>
                    					<div class="row">
                    						<button type="submit" class="btn btn-success" style="width: 100%">Cadastrar Desvio</button>
                    					</div>
                    					<div class="row">
                    		...
                    		<div class="input-group input-group-sm mb-3">
  									<div class="input-group-prepend">
    									<span class="input-group-text" id="inputGroup-sizing-sm" style="color: black; "><strong>Justificativa</strong></span>
  									</div>
  									<textarea class="endereco" id="endereco" class="form-control" id="enderecoCompleto" name="justificativa" style="background-color: white; width: 80%" value=""></textarea>
								</div>
                    		</div>
                    	</div>
					</div>
